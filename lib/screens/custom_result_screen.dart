...
class CustomResultScreen extends StatefulWidget {
  @override
  State<CustomResultScreen> createState() => _CustomResultScreenState();
}

class _CustomResultScreenState extends State<CustomResultScreen> {
  ...
  Text dconvertToLocalTime(String utcTimeString) {
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  formatUtcToLocal(order.createdAt.toString()),
                                ),
                              ],
                            ),
                            SizedBox(height: 10),
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Visibility(
                                    visible:
                                        order.bundle!.bundleTitle.toString() !=
                                        "",
                                    child: Container(
                                      // color: Colors.cyan,
                                      height: 30,
                                  ...
                                  Visibility(
                                    visible:
                                        order.bundle!.validityType.toString() !=
                                        "",
                                    child: Container(
                                      // color: Colors.yellow,
                                      height: 30,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.fill,
                                  image: NetworkImage(
                                    order.bundle!.service!.company!.companyLogo
                                        .toString(),
                                  ),
                                ),
                                shape: BoxShape.circle,
